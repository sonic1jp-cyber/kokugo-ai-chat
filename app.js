...
function chooseModel(m){
  ...
  if(simple)return MODEL_SIMPLE;
  var deep=m.length>100&&/なぜ|具体的|分析|比較|うちの子|詳しく|についてもう少し|原因|対策|計画|スケジュール|志望校|過去問|偏差値が[上下]|伸び悩|についてどう思/.test(m);
